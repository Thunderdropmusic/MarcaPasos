...
void DrawMenus::drawMenuSettings(){
  switch(menusUI.nMenuSettings){
    ...
    case 5:
      ...
      switch(menusUI.seleccion){
        case 1:
          writeAt(0,1,byte(0)), lcd.print(nombreEscalas[p->escalaSeleccionada]), lcd.write(byte(1));
          printAt(0, 2, " "), printAt(12,2, charEscalasNotas[p->noteTone]), lcd.print(" ");
        case 2:
          printAt(0, 1, " "), lcd.print(nombreEscalas[p->escalaSeleccionada]), lcd.print(" ");
          writeAt(0, 2, byte(0)), lcd.print(nombreEscalas[p->noteTone]), lcd.write(byte(1));
