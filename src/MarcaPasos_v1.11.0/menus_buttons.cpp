...
Encoder miEncoder(19, 17); // Izquierda y derecha
...
void MenusButtons::gestionarMenu3(){
  ...
  switch(seleccion){
    case 1:
      if(btnArriba){ seleccion = 8; aplicarCambiosBotones(); }
      else if(btnAbajo){ seleccion = 2; aplicarCambiosBotones(); }
      else if(btnOk){
        nMenuSettings = 1;
        seleccion = 1;
    ...
    case 6:
      ...
      else if(btnOk){ nMenuSettings = 6; seleccion = presetsUI.indexSequence + 1; aplicarCambiosBotones(); }
      break;
    case 7:
      ...
      break;
    case 8:
      if(btnArriba){ seleccion = 7; aplicarCambiosBotones(); }
      else if(btnAbajo){ seleccion = 1; aplicarCambiosBotones(); }
      else if(btnOk){ nMenuSettings = 8; seleccion = 1; aplicarCambiosBotones(); }
      break;
  }
}
