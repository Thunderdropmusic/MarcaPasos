...
const byte pinButton3 = 24; // Abajo
const byte pinButton4 = 25; // Volver
const byte pinButton5 = 26; // Izquierda
const byte pinButton6 = 28; // Derecha
const byte potesPin[3] = {A0, A1, A2};

//Valores potenciometros
const int numPotes = 3;
int potesValue[numPotes]; //Valores detectador
...
void checkPotes() {
  for(int i = 0; i < numPotes; i++){
    int val = constrain(map(analogRead(potesPin[i]), 1018, 8, 48, 60), 48, 60);
    potesValue[i] = val;
