...
extern void polleoMidiInterrupt();
...
// ==============================================================================
  ...
  MenusButtons();
    ...
    //Variables pines
    const byte pinButton1 = 29; // Arriba
    const byte pinButton2 = 18; // OK / Entrar
    const byte pinButton3 = 25; // Izquierda
    const byte pinButton4 = 23; // Abajo
    const byte pinButton5 = 27; // Derecha

    const byte extPin = 39;

    const byte settingsPin = 30;
